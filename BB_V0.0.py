...
price=np.matrix([10,20,30,50,40])
price=np.tile(price,S)
di=np.array([12,14,16,18,20])#demand of hot water drawn during i-th time step
c_water=431.7 #specific heat of water
tmp_required=80 #desired water temperature
tmp_up=80 #upper limit of water temperature in storage
mass=50 #mass of water in full storage
tmp_o=25 #initial water temperature in storage
tmp_step=np.array([35,45,55,65,75])
...
res=optimize.linprog(price,A_eq=a,b_eq=b,A_ub=d,b_ub=e,bounds=((0,20),(0,20),(0,20),(0,20),(0,20),(0,40),(0,40),(0,40),
(0,40),(0,40),(0,15),(0,15),(0,15),(0,15),(0,15),(0,20),(0,20),(0,20),(0,20),(0,20),(0,25),(0,25),(0,25),(0,25),(0,25)))
print (res.x)
print (res.fun)