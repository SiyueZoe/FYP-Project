# Pymprog_all - the MILP solution for scheduling in 24 hours using Pymprog
# Input:
#   For All:
...
#   For NL:
#       L - the duration of the task [vector]
#       P_NL - the rated power [vector]
#       NL_b - the beginning time [vector]
#       NL_e - the ending time [vector]
#   For IL:
#       P_IL - the rated power (kW) [vector]
#       E_IL - the energy (kWmin) [vector]
#       T_off - the minimum length of off time-step [vector]
#       Pmin - minimum power to turn on the appliance (kW) [vector]
#       IL_b - the beginning time [vector]
#       IL_e - the ending time [vector]
#   For TCL:
#       P_TCL - the rated power [vector]
#       c_water - specific heat of water(kW min/gallon°C) [scalar]
#       m - mass of water in full storage (gallon) [vector]
#       temp_up - upper limit of water temperature in storage (°C) [vector]
#       temp_o - initial water temperature in storage (°C) [vector]
#       temp_req - desired / required water temperature (°C) [vector]
#       temp_en - environmental temperature at the i-th time step (°C) [vector]
#       di - demand of hot water drawn during i-th time step (gallon) [vector]

# Output:
#       vobj() - total cost of all appliances
#       result_NL - the optimal power distribution of NL
#       result_IL - the optimal power distribution of IL
#       result_TCL - the optimal power distribution of TCL
#       result_ALL - the optimal power distribution of all appliances
